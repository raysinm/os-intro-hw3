...
void requestServeDynamic(int fd, char *filename, char *cgiargs, stats* stats, struct timeval dispatch)
{
...
void requestServeStatic(int fd, char *filename, int filesize, struct timeval dispatch) 
{
   int srcfd;
